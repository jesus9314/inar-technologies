        ...
        <x-filament::section>
            <div>
                <div class="flex justify-between xl:gap-60 lg:gap-48 md:gap-16 sm:gap-8 sm:flex-row flex-col gap-4">
                    <div class="w-full">
                        <div>
                            <img src="{{ url('storage/' . setting('site_logo')) }}" alt="{{ setting('site_name') }}"
                                class="w-16">
                        </div>
                            ...
                            <div class="flex flex-col justify-end">
                                <div>
                                    ...
                                    <div class="flex justify-between gap-4">
                                        ...
                                        <div>{{ type_of($this->getRecord()->status, 'invoices', 'status')->name }}
                                        </div>
                                    </div>
                                    <div class="flex justify-between gap-4">
                                        <div class="text-gray-400">
                                        ...
                                        <div class="p-2">
                                            <div class="flex flex-col mt-2">
                                                    ...
                                                    <div class="flex justify-between">
                                                        ...
                                                        <span class="w-full">
                                                            {{ number_format($item->price, 2) }}<small
                                                                class="text-md font-normal">{{ $this->getRecord()->currency?->iso }}
                                                            </small>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="flex justify-between">
                                                        <span
                                                            class="text-sm text-gray-400 uppercase w-full">{{ trans('filament-invoices::messages.invoices.view.vat') }}:</span>
                                                        <span class="w-full">
                                                            {{ number_format($item->tax, 2) }}<small
                                                                class="text-md font-normal">{{ $this->getRecord()->currency?->iso }}</small>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="flex justify-between">
                                                        ...
                                                        <span class="w-full">
                                                            {{ number_format($item->discount, 2) }}<small
                                                                class="text-md font-normal">{{ $this->getRecord()->currency?->iso }}</small>
                                                        </span>
                                                    </div>
                                                </div>
                    ...
                    <div class="flex justify-between mt-6">
                        ...
                        <div class="flex flex-col gap-2 mt-4  w-full">
                            <div class="flex justify-between">
                                ...
                                <div>
                                    {{ number_format($this->getRecord()->total + $this->getRecord()->discount - ($this->getRecord()->vat + $this->getRecord()->shipping), 2) }}<small
                                        class="text-md font-normal">{{ $this->getRecord()->currency?->iso }}</small>
                                </div>
                            </div>
                            <div class="flex justify-between">
