...
use App\Filament\Clusters\Codes\Resources\DeviceStatusResource\Pages;
use App\Filament\Clusters\Codes\Resources\DeviceStatusResource\RelationManagers;
...
class DeviceStatusResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ManageDeviceStatuses::route('/'),
        ];
    }
}
