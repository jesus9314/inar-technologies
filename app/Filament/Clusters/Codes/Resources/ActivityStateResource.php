...
use App\Filament\Clusters\Codes\Resources\ActivityStateResource\Pages;
use App\Filament\Clusters\Codes\Resources\ActivityStateResource\RelationManagers;
...
class ActivityStateResource extends Resource
{
    protected static ?string $model = ActivityState::class;
    ...
    {
        return [
            'index' => Pages\ManageActivityStates::route('/'),
        ];
    }
}
