...
class IdDocumentPolicy
{
    ...
    {
        return $user->can('view_any_id::document');
    }
    ...
    {
        return $user->can('view_id::document');
    }
    ...
    {
        return $user->can('create_id::document');
    }
    ...
    {
        return $user->can('update_id::document');
    }
    ...
    {
        return $user->can('delete_id::document');
    }
    ...
    {
        return $user->can('delete_any_id::document');
    }
     ...
     */
    public function replicate(User $user, IdDocument $idDocument): bool
    {
        return $user->can('replicate_id::document');
    }
