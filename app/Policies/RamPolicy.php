...
class RamPolicy
{
    ...
    {
        return $user->can('force_delete_ram');
    }
    ...
    {
        return $user->can('force_delete_any_ram');
    }
    ...
    {
        return $user->can('restore_any_ram');
    }
