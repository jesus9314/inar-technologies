...
class AffectationPolicy
{
    ...
    {
        return $user->can('view_any_affectation');
    }
    ...
    {
        return $user->can('view_affectation');
    }
    ...
    {
        return $user->can('create_affectation');
    }
    ...
    {
        return $user->can('update_affectation');
    }
    ...
    {
        return $user->can('delete_affectation');
    }
    ...
    {
        return $user->can('delete_any_affectation');
    }
     ...
     */
    public function replicate(User $user, Affectation $affectation): bool
    {
        return $user->can('replicate_affectation');
    }
